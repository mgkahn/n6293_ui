...
- Software added for NURS6293:
 ...
 - DockerHub image (multiarch): 
   - Mac: `startCompose.sh` (uses local docker-compose.yml) or `startCompose2.sh` (uses embedded docker-compose.yml)
 ...
 - Figure out how to send SIGTERM generated by `KillSession` to DBMS docker.
   - Can remove ugly --abort-on-container-exit hack
