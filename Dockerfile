...
RUN apt-get update && apt-get install -y openjdk-17-jre libreoffice libreoffice-sdbc-firebird flamerobin cups printer-driver-cups-pdf iputils-ping netcat
